...
const CashReceiptPage: React.FC = () => {
  ...
  const handleSuccess = (response: any) => {
    message.success('Kasa tahsilat işlemi başarıyla kaydedildi');
    ...
    <div>
      <div style={{ marginBottom: 16, padding: '16px 24px', backgroundColor: '#fff' }}>
        <Space>
          ...
          />
          <div>
            <Title level={4} style={{ margin: 0 }}>Kasa Tahsil Fişi</Title>
            <div style={{ color: 'rgba(0, 0, 0, 0.45)' }}>Yeni kasa tahsilat fişi oluştur</div>
          </div>
        </Space>
      </div>
      <Card>
        <CashVoucherForm 
          voucherType={CashVoucherType.RECEIPT}
